...
public class OrderController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String productCode = request.getParameter("addToCart");
        ...
        if (productCode != null) {
            if (session.getAttribute("theShoppingCart") == null) {
                ...
                theShoppingCart.addItem(pDB.getProduct(productCode), 1);
            ...
            for (OrderItem o : orderitems) {
                ...
                if (request.getParameter(pc) == null) {
                    ...
                    theShoppingCart.addItem(o.getProduct(), quant);
                }
                if (a != o.getQuantity()) {
                    if (a < 1) {
